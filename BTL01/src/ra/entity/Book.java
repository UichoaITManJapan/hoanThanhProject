...
public class Book implements IEntity, Serializable {
    ...
    public String validateBookId() {
        System.out.println(ColorManager.TRANGNHAT +"Nhập vào mã sách :"+ColorManager.RESET);
        do {
    ...
    public static String validateBookTitle() {
        System.out.println(ColorManager.TRANGNHAT+"Nhập vào tiêu đề sách :"+ColorManager.RESET);
        do {
    ...
    public static String validateBookAuthor() {
        System.out.println(ColorManager.TRANGNHAT+"Nhập vào tên tác giả :"+ColorManager.RESET);
        do {
    ...
    public static String validateBookPusblisher() {
        System.out.println(ColorManager.TRANGNHAT+"Nhập vào tên nhà xuất bản :"+ColorManager.RESET);
        do {
    ...
    public static int validateBookYear() {
        System.out.println(ColorManager.TRANGNHAT+"Nhập vào năm xuất bản :"+ColorManager.RESET);
        do {
    ...
    public static String validateBookDescription() {
        System.out.println(ColorManager.TRANGNHAT+"Nhập vào mô tả sách :"+ColorManager.RESET);
        do {
    ...
    public static int validateCategoryId(){
        System.out.println(ColorManager.TRANGNHAT+"Nhập vào mã thể loại sách :"+ColorManager.RESET);
        do {
...
//        System.out.format("+------------+----------------------------------------+------------------+----------------+-------+------------------+------------------+");
    ...
    public void outPutOfCatalogNameAndBookName(){
        System.out.printf(ColorManager.YELLOW+" %-15s  %-10s\n"+ColorManager.RESET," ",title);
    }
    }
