...
public class CatalogMenu {
    public static void catalogMenu() {
            ...
            do {
                ...
                System.out.println("⎜                        "+ColorManager.PINK+"QUẢN LÝ THỂ LOẠI"+ColorManager.RESET+ColorManager.PURPLE+"                        ⎜");
                System.out.println("┼----------------------------------------------------------------┼");
                System.out.println("⎜ "+ColorManager.YELLOW+"➣ 1."+ColorManager.RESET+ColorManager.PURPLE+" ⎜    "+ColorManager.TRANGNHAT+"Thêm mới thể loại"+ColorManager.RESET+ColorManager.PURPLE+"                                    ⎜");
                System.out.println("⎜ "+ColorManager.YELLOW+"➣ 2."+ColorManager.RESET+ColorManager.PURPLE+" ⎜    "+ColorManager.TRANGNHAT+"Hiển thị danh sách theo tên A – Z"+ColorManager.RESET+ColorManager.PURPLE+"                    ⎜");
                System.out.println("⎜ "+ColorManager.YELLOW+"➣ 3."+ColorManager.RESET+ColorManager.PURPLE+" ⎜    "+ColorManager.TRANGNHAT+"Thống kê thể loại và số sách có trong mỗi thể loại"+ColorManager.RESET+ColorManager.PURPLE+"   ⎜");
                System.out.println("⎜ "+ColorManager.YELLOW+"➣ 4."+ColorManager.RESET+ColorManager.PURPLE+" ⎜    "+ColorManager.TRANGNHAT+"Cập nhật thể loại"+ColorManager.RESET+ColorManager.PURPLE+"                                    ⎜");
                System.out.println("⎜ "+ColorManager.YELLOW+"➣ 5."+ColorManager.RESET+ColorManager.PURPLE+" ⎜    "+ColorManager.TRANGNHAT+"Xóa thể loại"+ColorManager.RESET+ColorManager.PURPLE+"                                         ⎜");
        ...
        public static void addCatalog(){
            System.out.println(ColorManager.PINK+"Nhập vào số lượng thể loại :"+ColorManager.RESET);
            do {
                try {
                    int n = Integer.parseInt(scanner.nextLine());
                    for (int i = 0; i < n; i++) {
                        System.out.println(ColorManager.TRANGSUA+"✦✦✦✦✦✦✦✦✦✦✦ Nhập thông tin thể loại sách thứ " + (i + 1) + " ✦✦✦✦✦✦✦✦✦✦✦"+ColorManager.RESET);
        ...
        public static void displayCatalogASC(){
            ...
            System.out.println(ColorManager.TRANGSUA+"◆ \tMã\t\t Tên thể loại\t\t  Trạng thái\t\t\t ◆"+ColorManager.RESET);
            System.out.println(ColorManager.BLUE+"◆                                                        ◆");
        ...
        public static void staticCatalog(){
            System.out.println();
            System.out.println(ColorManager.TRANGSUA+"\t✧✧✧✧✧✧✧✧✧✧✧ THỐNG KÊ THỂ LOẠI VÀ SỐ SÁCH ✧✧✧✧✧✧✧✧✧✧✧✧✧"+ColorManager.RESET);
            System.out.println();
            for (Category category : categoryList) {
        int cntBook = (int) bookList.stream().filter(book -> book.getCatalogId() == category.getId()).count();
                System.out.println(ColorManager.TRANGSUA+"\t\tThể loại : "+ColorManager.RESET+ColorManager.PURPLE+category.getName()+ColorManager.RESET+ColorManager.TRANGSUA+"\t-\t Số sách : "+ColorManager.RESET+ColorManager.VANGDAM + cntBook+ColorManager.RESET);
            }
            System.out.println();
            System.out.println();
        }
    ...
    public static void deleteCatalog(){
        ...
        if (isHasBooksReferencingCategory){
            ...
            if (!isCheckCatalogDel){
                ...
                System.out.println();
                System.out.println(ColorManager.GREEN+"Đã xoá thể loại " + catalogIdDel +" thành công ✔︎"+ColorManager.RESET);
            }
        }
        System.out.println();
        System.out.println();
